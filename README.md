...
The system is designed to be remotely accessed for debugging and telemetry purposes.  To do this, we set up the Rasberry Pi to act as a wireless acess point, ensuring that even in areas without wirless networks, a seperate laptop can be used to access the pi.
